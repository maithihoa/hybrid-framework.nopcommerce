...
public class Level_11_Register_Login_Element_Undisplay extends BasePage{
	...
	public void TC_01_Check_Element_Displayed() {
		...
		status = isElementDisplay(driver,"//a[@class='ico-login']");
		System.out.println("Element displays is:" + status);
		sleepInSecond(2);
	}
	@Test
	public void TC_02_Check_Element_NOT_Displayed_And_Exists_In_DOM() {
	...
	@Test
	public void TC_03_Check_Element_NOT_Displayed_And_Dont_Exists_In_DOM() {
	...
	@Test
	public void TC_04_Check_Element_NOT_Displayed_By_Wait() {
		driver.get("https://shopee.vn/");
		driver.findElement(By.xpath("//div[@class='shopee-popup__close-btn']")).click();
